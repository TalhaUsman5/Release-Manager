...
<style>
:root{color-scheme:light;--page:#f4f7fb;--surface:#fff;--surface-soft:#f8fafc;--text:#15233b;--muted:#5c687a;--border:#d8e0ea;--primary:#2754c5;--primary-dark:#193f9f;--primary-soft:#eaf0ff;--danger:#b42332;--danger-dark:#8f1724;--success:#18794e;--shadow:0 12px 32px rgba(29,50,88,.09);--radius:1rem}*{box-sizing:border-box}html{scroll-behavior:smooth}body{min-width:0;margin:0;font:16px/1.6 Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text);background:linear-gradient(180deg,#edf3ff 0,#f7f9fc 24rem,var(--page) 100%)}body>main,body>.site-footer,.site-header-inner{width:min(100% - 2.5rem,1120px);margin-inline:auto}a{color:var(--primary);font-weight:650;text-decoration-thickness:.08em;text-underline-offset:.18em;transition:color .18s ease,background-color .18s ease,box-shadow .18s ease,transform .18s ease}a:hover{color:var(--primary-dark)}a:focus-visible,button:focus-visible,input:focus-visible,select:focus-visible,summary:focus-visible{outline:3px solid #f4b740;outline-offset:3px}.site-header{background:rgba(255,255,255,.94);border-bottom:1px solid rgba(216,224,234,.9);box-shadow:0 2px 16px rgba(29,50,88,.05)}.site-header-inner{padding:1rem 0}.primary-nav{display:flex;flex-wrap:wrap;gap:.5rem;align-items:center}.primary-nav a{padding:.55rem .75rem;border-radius:.65rem;text-decoration:none}.primary-nav a:not(.brand):hover{background:var(--primary-soft)}.brand{margin-right:auto;color:var(--text);font-size:1.05rem;font-weight:800;letter-spacing:-.02em}.brand:hover{color:var(--primary)}.brand-mark{display:inline-grid;width:2rem;height:2rem;margin-right:.55rem;place-items:center;border-radius:.6rem;color:#fff;background:linear-gradient(135deg,#3468df,#193f9f);box-shadow:0 5px 14px rgba(39,84,197,.25)}.activity{display:flex;flex-wrap:wrap;gap:.35rem 1.25rem;align-items:center;margin-top:.8rem;padding:.65rem .85rem;border:1px solid var(--border);border-left:.3rem solid var(--muted);border-radius:.65rem;background:var(--surface-soft);color:var(--muted);font-size:.9rem}.activity-label{color:var(--text);font-weight:800}.activity-success{border-left-color:var(--success)}.activity-failure{border-left-color:var(--danger)}.error,.activity-failure{color:var(--danger)}main{padding:3rem 0 1rem}.hero{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:2rem;align-items:center;margin-bottom:2rem;padding:clamp(1.5rem,4vw,3rem);overflow:hidden;border:1px solid #d9e3fb;border-radius:1.4rem;background:linear-gradient(135deg,#fff 0%,#f8faff 64%,#e9f0ff 100%);box-shadow:var(--shadow)}.eyebrow{margin:0 0 .55rem;color:var(--primary);font-size:.78rem;font-weight:850;letter-spacing:.13em;text-transform:uppercase}.hero h1{max-width:16ch;margin:0;font-size:clamp(2rem,5vw,3.7rem);line-height:1.05;letter-spacing:-.045em}.hero-copy{max-width:62ch;margin:1rem 0 0;color:var(--muted);font-size:1.08rem}.hero-action{display:inline-flex;align-items:center;justify-content:center;min-height:3rem;padding:.7rem 1.1rem;border:1px solid var(--primary);border-radius:.75rem;color:#fff;background:var(--primary);box-shadow:0 8px 20px rgba(39,84,197,.22);text-align:center;text-decoration:none;white-space:nowrap}.hero-action:hover{color:#fff;background:var(--primary-dark);transform:translateY(-1px)}.content-heading{margin:2.5rem 0 .25rem;font-size:clamp(1.45rem,3vw,2rem);letter-spacing:-.025em}.section-intro,.meta{max-width:70ch;margin:.2rem 0 1.25rem;color:var(--muted)}.status-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem}.status-grid>section,.complete-status,.action-card,main>section{min-width:0;border:1px solid var(--border);border-radius:var(--radius);padding:1.25rem;margin:0;background:var(--surface);box-shadow:0 5px 18px rgba(29,50,88,.045)}.status-grid>section{border-top:4px solid #b8c9f5}.status-grid h2,.complete-status h2{margin:0 0 .75rem;font-size:1.08rem;letter-spacing:-.01em}.complete-status{margin-top:1rem}.complete-status>summary{cursor:pointer;font-weight:800;list-style-position:outside}.complete-status>summary:hover{color:var(--primary)}.complete-status[open]>summary{margin-bottom:1rem}.actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem}.action-card{display:flex;flex-direction:column;padding:1.2rem}.action-card h3{margin:0 0 .9rem;font-size:1.08rem}.action-card form{display:flex;flex:1;flex-direction:column;gap:.75rem}.action-card button{margin-top:auto}.action-approve,.action-publish{border-top:4px solid var(--success)}.action-reject{border-top:4px solid var(--danger)}dl{margin:.4rem 0}dt{margin-top:.7rem;color:var(--muted);font-size:.78rem;font-weight:800;letter-spacing:.05em;text-transform:uppercase}dd{min-width:0;margin-left:0;overflow-wrap:anywhere}ol{padding-left:1.25rem}pre{max-width:100%;padding:1rem;overflow:auto;border:1px solid var(--border);border-radius:.65rem;white-space:pre-wrap;overflow-wrap:anywhere;background:#f7f9fc;font:13px/1.55 ui-monospace,SFMono-Regular,Consolas,monospace}label{display:grid;gap:.4rem;color:var(--muted);font-size:.88rem;font-weight:750}input,select,button{width:100%;min-height:2.75rem;padding:.55rem .7rem;border:1px solid #b9c5d4;border-radius:.6rem;font:inherit;color:var(--text);background:#fff;transition:border-color .18s ease,box-shadow .18s ease,background-color .18s ease,transform .18s ease}input:hover,select:hover{border-color:#7d91ab}input:focus,select:focus{border-color:var(--primary);box-shadow:0 0 0 3px rgba(39,84,197,.12)}button{cursor:pointer;border-color:var(--primary);color:#fff;font-weight:800;background:var(--primary);box-shadow:0 5px 12px rgba(39,84,197,.18)}button:hover{background:var(--primary-dark);transform:translateY(-1px)}button:active{transform:translateY(0)}.action-reject button{border-color:var(--danger);background:var(--danger)}.action-reject button:hover{background:var(--danger-dark)}.stream{margin-top:1rem}.stream-stdout{border-left:.35rem solid #176b45}.stream-stderr{border-left:.35rem solid #a2303d}details.stream>summary{cursor:pointer;padding:.85rem;font-weight:800}.stream-size{margin-left:.7rem;color:var(--muted);font-size:.85rem;font-weight:500}.site-footer{display:flex;flex-wrap:wrap;gap:.75rem 1.5rem;margin-top:2rem;padding:1.5rem 0 2.5rem;border-top:1px solid var(--border);color:var(--muted);font-size:.9rem}.site-footer a{padding:.25rem 0}.null,.empty{color:var(--muted);font-family:ui-monospace,SFMono-Regular,Consolas,monospace}@media (prefers-color-scheme: dark){:root{color-scheme:dark;--page:#0b1220;--surface:#111b2e;--surface-soft:#172338;--text:#edf3ff;--muted:#a9b7ca;--border:#34445d;--primary:#8eafff;--primary-dark:#b6cbff;--primary-soft:#22365f;--danger:#ff8995;--danger-dark:#ffb0b8;--success:#62d7a2;--shadow:0 12px 32px rgba(0,0,0,.42)}body{background:linear-gradient(180deg,#101a2d 0,#0d1626 24rem,var(--page) 100%)}.site-header{background:rgba(17,27,46,.96);border-bottom-color:var(--border);box-shadow:0 2px 16px rgba(0,0,0,.3)}.hero{border-color:var(--border);background:linear-gradient(135deg,var(--surface) 0%,#142039 64%,#19294a 100%)}pre{background:var(--surface-soft)}input,select{border-color:var(--border);color:var(--text);background:var(--surface-soft)}input:hover,select:hover{border-color:var(--muted)}option{color:var(--text);background:var(--surface)}button,.hero-action,.hero-action:hover,.action-reject button{color:#07111f}.status-grid>section{border-top-color:#5875ad}.stream-stdout{border-left-color:var(--success)}.stream-stderr{border-left-color:var(--danger)}}@media(max-width:800px){.hero{grid-template-columns:1fr}.hero-action{justify-self:start}.actions{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:560px){body>main,body>.site-footer,.site-header-inner{width:min(100% - 1.5rem,1120px)}main{padding-top:1.5rem}.primary-nav{align-items:stretch}.brand{flex-basis:100%;margin-right:0}.primary-nav a:not(.brand){flex:1;text-align:center}.activity{align-items:flex-start;flex-direction:column}.hero{gap:1.25rem;padding:1.35rem;border-radius:1rem}.hero h1{font-size:2.15rem}.hero-action{width:100%}.status-grid,.actions{grid-template-columns:minmax(0,1fr)}.status-grid>section,.complete-status,.action-card,main>section{padding:1rem}.stream-size{display:block;margin-left:0}.site-footer{align-items:flex-start;flex-direction:column}}@media(prefers-reduced-motion:reduce){html{scroll-behavior:auto}*,*::before,*::after{transition-duration:.01ms!important}}
</style>
</head>
<body>
<header class="site-header"><div class="site-header-inner"><nav class="primary-nav" aria-label="Primary navigation"><a class="brand" href="/"><span class="brand-mark" aria-hidden="true">R</span>Release Manager Review</a><a href="/">Release status</a><a href="/audit">Audit history</a></nav>${renderRecentActivity()}</div></header>
<main>${body}</main>
<footer class="site-footer" aria-label="Release evidence links"><a href="/evidence/trace">Self-hosted Shipyard execution trace</a><a href="/evidence/session">Self-hosted Shipyard session JSON</a><a href="/evidence/events">Self-hosted Shipyard events JSONL</a></footer>
</body>
</html>`;
}
...
function appendAudit(args, result) {
  ...
  return fs.promises.appendFile(AUDIT_PATH, `${JSON.stringify(entry)}\n`, 'utf8').then(() => entry);
}
...
function renderMainPage(status) {
  ...
  const actions = [
    ...
    ['reject', 'Reject', ''],
    ['publish', 'Publish', '']
  ].map(([routeName, label, fields]) => `<section class="action-card action-${routeName}"><h3>${label}</h3><form method="post" action="/${routeName}" enctype="application/x-www-form-urlencoded">${fields}<button type="submit">${label}</button></form></section>`).join('');
  return `<section class="hero" aria-labelledby="page-title"><div><p class="eyebrow">Release workflow</p><h1 id="page-title">Release Manager Review</h1><p class="hero-copy">Review the current workflow status, inspect release evidence, and use the available release actions in one organized workspace.</p></div><a class="hero-action" href="/audit">Review audit history</a></section><section aria-labelledby="status-heading"><h2 class="content-heading" id="status-heading">Current release status</h2><p class="meta">Workflow state below was obtained from the Release Manager CLI status command.</p><div class="status-grid">${sections}</div><details class="complete-status"><summary>Complete Status Output</summary>${renderValue(status)}</details></section><section id="release-actions" aria-labelledby="actions-heading"><h2 class="content-heading" id="actions-heading">Actions</h2><p class="section-intro">Choose an available workflow action below. Each control continues to use the existing Release Manager operation.</p><div class="actions">${actions}</div></section>`;
}
